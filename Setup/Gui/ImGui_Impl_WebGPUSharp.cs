    ...
    public static bool CreateDeviceObjects()
    {
        ...
        // Create render pipeline
        {
            ...
            VertexState vertexState;
            {
                ...
                var module = bd.device.CreateShaderModule(new ShaderModuleDescriptor(vertexDescriptor));
                ...
                vertexState = new VertexState()
                {
                    ...
                    Buffers = [
                         new()
                         {
                             ArrayStride = (ulong)Marshal.SizeOf<ImDrawVert>(),
                            ...
                            [
                                new()
                                {
                                    ...
                                    Offset = (ulong)Marshal.OffsetOf<ImDrawVert>("pos"), // TODO fix: Causes GC
                                    ShaderLocation = 0,
                                },
                                new()
                                {
                                    Format = VertexFormat.Float32x2,
                                    Offset = (ulong)Marshal.OffsetOf<ImDrawVert>("uv"),
                                    ShaderLocation = 1,
                                },
                                new()
                                {
                                    Format = VertexFormat.Unorm8x4,
                                    Offset = (ulong)Marshal.OffsetOf<ImDrawVert>("col"),
                                    ShaderLocation = 2,
                                }
                            ]
                         },
