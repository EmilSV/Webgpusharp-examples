...
public unsafe static class EmscriptenInterop
{
    ...
    [DllImport("emscripten", CallingConvention = CallingConvention.Cdecl, EntryPoint = "emscripten_cancel_main_loop")]
    public extern static void emscripten_cancel_main_loop();
