...
public static class Cube
{
    ...
    public static readonly (Vector4 position, Vector4 color, Vector2 uv)[] CubeVertexArray = [
        ...
        (new(-1, 1, 1, 1),  new(0, 1, 1, 1),  new(1, 1)),
        (new(-1, 1, -1, 1), new(0, 1, 0, 1),  new(1, 0)),
        (new(-1, -1, -1, 1),new(0, 0, 0, 1),  new(0, 0)),
        (new(-1, -1, 1, 1), new(0, 0, 1, 1),  new(0, 1)),
        (new(-1, 1, -1, 1), new(0, 1, 0, 1),  new(1, 0)),

        (new(1, 1, 1, 1),   new(1, 1, 1, 1), new(0, 1)),
        (new(-1, 1, 1, 1),  new(0, 1, 1, 1), new(1, 1)),
        (new(-1, -1, 1, 1), new(0, 0, 1, 1), new(1, 0)),
        (new(-1, -1, 1, 1), new(0, 0, 1, 1), new(1, 0)),
        (new(1, -1, 1, 1),  new(1, 0, 1, 1), new(0, 0)),
        (new(1, 1, 1, 1),   new(1, 1, 1, 1), new(0, 1)),
